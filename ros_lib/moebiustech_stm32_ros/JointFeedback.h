#ifndef _ROS_moebiustech_stm32_ros_JointFeedback_h
#define _ROS_moebiustech_stm32_ros_JointFeedback_h
...
namespace moebiustech_stm32_ros
{
  ...
  class JointFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "moebiustech_stm32_ros/JointFeedback"; };
    virtual const char * getMD5() override { return "6c66d61c0419d0645fff2bdc292447ca"; };
