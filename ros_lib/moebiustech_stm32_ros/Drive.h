#ifndef _ROS_moebiustech_stm32_ros_Drive_h
#define _ROS_moebiustech_stm32_ros_Drive_h
...
namespace moebiustech_stm32_ros
{
  ...
  class Drive : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "moebiustech_stm32_ros/Drive"; };
    virtual const char * getMD5() override { return "bd2f9d7d37189a26f56c02d747ac1ca3"; };
